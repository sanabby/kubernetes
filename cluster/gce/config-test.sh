...
MASTER_IMAGE=${KUBE_GCE_MASTER_IMAGE:-container-vm-v20160121}
...
if [[ $NETWORK_PROVIDER == "opencontrail" ]]; then
    ...
    NETWORK_PROVIDER_GATEWAY_NAME="${INSTANCE_PREFIX}-${NETWORK_PROVIDER}-gateway"
    NETWORK_PROVIDER_GATEWAY_TAG="${NETWORK_PROVIDER_GATEWAY_NAME}"
